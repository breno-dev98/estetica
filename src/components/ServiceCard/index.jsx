...
const ServiceCard = ({ title, description, price, border, backgroundColor, onClick }) => {
  return (
    <div onClick={onClick} className={`${backgroundColor} ${border} p-6 rounded-lg shadow-md sm:w-80 md:w-[450px] w-full h-full flex flex-col justify-between text-center`}>
      <div>
